...
import time
import os
from model import ft_net, ft_net_dense, AngleLoss
...
parser.add_argument('--data_dir',default='/home/xiongfu/xiongfu/market/pytorch',type=str, help='training dir path')
...
#        transforms.RandomCrop((256,128)),
        transforms.Pad(10),
        transforms.RandomCrop((256,128)), #(256,128)
...
#             {'params': model.fc0.parameters(), 'lr': 0.01}
